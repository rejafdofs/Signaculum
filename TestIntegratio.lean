...
-- ═══════════════════════════════════════════════════
catena testumCatena := [
  do sakura; loqui "チェイン第一話にゃん"; finis,
  do sakura; loqui "チェイン第二話にゃん"; finis
]

-- Exhibibilis 經由の exhibe にゃん（コンパイル通過＝型檢査成功）
def testumExhibeCatena : SakuraIO Unit := Signaculum.Notatio.Exhibibilis.exhibe testumCatena

-- eligeVelCatena の型檢査にゃん
def testumEligeVelCatena : SakuraIO Unit := do
  eligeVelCatena #[
    .simplex (do sakura; loqui "通常トークにゃ"; finis),
    .catena testumCatena
  ]

-- ═══════════════════════════════════════════════════
-- §12 construe（ラッパー自動生成＋登錄）
-- ═══════════════════════════════════════════════════
construe
